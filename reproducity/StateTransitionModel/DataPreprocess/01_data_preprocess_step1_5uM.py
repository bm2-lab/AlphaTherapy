...
inst_info = pd.read_table('GSE92742_Broad_LINCS_inst_info.txt', 
                          sep='\t', 
                          header=0, 
                          index_col=None,
                          low_memory=False)
...
# Filter by experimental concentration (~5uM)
concentration = 5.0
...
intermediate_file_name = DATA_DIR / "preprocessed_data_2025/state_transition_model_input_data/intermediate_file_5uM.pkl"
intermediate_file_name.parent.mkdir(parents=True, exist_ok=True) 

with open(intermediate_file_name, "wb") as f:
    pickle.dump([inst_info_trt_new, drug_df], f)
...
print("expre_data loading")
print(all_inst_id.shape)
...
#####################################################################
# Step 5: Save the data
data_path = DATA_DIR / "preprocessed_data_2025" / "state_transition_model_input_data" / "step1_LINCS_model_dataset_5uM.pkl"
