# Dataset for random split scenario for chemCPA
...
scaler_path = DATA_DIR / "preprocessed_data_2025/state_transition_model_benchmark/chemCPA/scaler.pkl"
scaler_path.parent.mkdir(parents=True, exist_ok=True)
with open(scaler_path, "wb") as f:
    pickle.dump([ss, ss4], f)

# data split
sample_number = cell_id.shape[0]
one_fold_number = int(sample_number * 0.1)
num_folds = 10
...
# split information, the same for our state transition model
...
print(reference_df.canonical_smiles.value_counts())
...
# 3. save data
adata_out = DATA_DIR / "preprocessed_data_2025/state_transition_model_benchmark/chemCPA/random_split.h5ad"  
