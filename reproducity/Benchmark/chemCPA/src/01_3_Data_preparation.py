# Dataset for compound blind scenario for chemCPA
...
# data split
sample_number = drug_name.shape[0]
init_one_fold_number = int(sample_number * 0.1)

unique_drug_names = np.unique(drug_name)
...
# 3. save datya
adata_out = DATA_DIR / "preprocessed_data_2025/state_transition_model_benchmark/chemCPA/chemical_blind.h5ad"  
